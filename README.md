...
create folder in /sdcard/ called "OptiCraft" and put assets.pak there

apk only works on arm64 and android >7, gonna try building it for arm32 and android 6 later
